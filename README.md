...
## OUTPUT:
![image](https://github.com/user-attachments/assets/cc26035e-19a9-4ef9-9752-a650256c21f6)


## RESULT:
The program for the Diffie-Hellman algorithm is executed successfully, and Alice and Bob have securely derived a shared secret key. Ex--10---Diffee-Hellman/README.md at main · K-Dharshini/Ex--10---Diffee-Hellman
